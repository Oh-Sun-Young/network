...
/*
 * 참고
 * - 유니티5 에서 안드로이드의 상태바 보이게 하기 : https://wingsnote.com/88
 * - 오픈소스 GitHUB URL : https://github.com/zeh/unity-tidbits
 * - Unity tidbits: changing the visibility of Android’s navigation and status bars, and implementing immersive mode : https://tsubakit1.hateblo.jp/entry/2016/01/23/041430
 */
...
class ApplicationChrome
{
    ...
    public enum States
    {
        Unknown,
        Visible, // 보이게 함 (영역 차지)
        VisibleOverContent, // 화면 위에 겹쳐서 나오게 함 (배경은 불투명한 색상)
        TranslucentOverContent, // 화면 위에 겹쳐서 나오게 함 (배경은 투명)
        Hidden // 안 보이게 함
    }
